...
sudo mkdir /mnt/nightfighter
# mount the new volume to the mounting point path
sudo mount /dev/xvdb /mnt/nightfighter
...
ls -lh /mnt/nightfighter/
#  if there is no data on it, create a new file to show persistence in later steps
cd /mnt/nightfighter
sudo vi test.txt
write "Your Name was Here.. For NightFighter"
cat test.txt 
read and check "Your Name was Here.. For NightFighter" 
...
sudo file -s /dev/xvdb
# mount the new volume to the mounting point path
sudo mount /dev/xvdf /mnt/nightfighter/
